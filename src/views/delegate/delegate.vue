<template>
  <div class="delegate container">
    ...
    <div class="tab-standby" v-show="tab === 2">
      <div class="table-box">
        <div class="table-scroll">
          <standbyTable :tableData="standbyData"></standbyTable>
        </div>
      </div>
    </div>
  </div>
  ...
  data(){
    return {
      ...
      delegatesData: [{
        rank: 1,
        name: 'hdalshfla89',
        address: 'fjdkashue83174190rwei',
        forged: '412354253',
        time: '2017/32/32 39:32',
        status: 1,
        productivity: '96.3%',
        approval: '42.34%'
      },{
